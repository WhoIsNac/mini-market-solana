...
const ROUTES = [
  ...
  { url: RouteName.Displayauction, name: "Auction List" },
  { url: RouteName.auction, name: "Create Auction" },
  { url: RouteName.mint, name: "Mint new Collection" },
